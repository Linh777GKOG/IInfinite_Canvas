...
class DrawingSidebar extends StatelessWidget {
  ...
  final VoidCallback onSelectShape;
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildToolBtn(
              icon: Icons
                  .cleaning_services_rounded, // Hoặc Icons.edit_off_rounded
            ...
            _buildToolBtn(
              ...
              isActive: activeTool == ActiveTool.lasso,
              onTap: onSelectLasso,
            ),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isActive
              ? Colors.black87
              : Colors.white, // Đen nếu chọn, Trắng nếu không
          shape: BoxShape.circle,
        ...
        child: Icon(
          ...
          color: isActive
              ? Colors.white
              : Colors.black54, // Icon trắng nếu chọn
          size: 20,
        ),
      ),
    );
